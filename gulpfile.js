...
gulp.task('vendors', ['bower'], function () {
  ...
  return gulp.src([
    './.tmp/vendors/**/*.js',
    './node_modules/bootstrap/dist/js/bootstrap.bundle.min.js'])//bootstrap.js poper.js 一起
...
gulp.task('browser-sync', function () {
  browserSync.init({
    server: {
      ...
      reloadDebounce: 2000 //重新整理完兩秒內不能重整
    }
  });
});
//壓縮圖片  imagemin
...
gulp.task('build', gulpSequence('clean','copyHTML', 'sass', 'babel', 'vendors'))
